...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> getData() async {
    ...
    final snapshot = await doc
        .get(); //This line asynchronously retrieves the document snapshot using the get() method
    if (snapshot.exists) {
      setState(() {
        print(
            "userdata exist"); //It takes the data from the Firestore document (snapshot.data()) and converts it into a map before passing it to the fromMap method.
        modelClass = ModelClass.fromMap(snapshot.data() as Map<String,
